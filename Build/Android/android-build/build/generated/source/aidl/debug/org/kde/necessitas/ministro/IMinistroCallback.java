  ...
  public static abstract class Stub extends android.os.Binder implements org.kde.necessitas.ministro.IMinistroCallback
  {
    ...
    private static class Proxy implements org.kde.necessitas.ministro.IMinistroCallback
    {
      ...
      */
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().loaderReady(loaderParams);
              return;
            }
          }
        }
      ...
      public static org.kde.necessitas.ministro.IMinistroCallback sDefaultImpl;
    }
    static final int TRANSACTION_loaderReady = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(org.kde.necessitas.ministro.IMinistroCallback impl) {
    ...
    public static org.kde.necessitas.ministro.IMinistroCallback getDefaultImpl() {
