  ...
  public static abstract class Stub extends android.os.Binder implements org.kde.necessitas.ministro.IMinistro
  {
    ...
    private static class Proxy implements org.kde.necessitas.ministro.IMinistro
    {
      ...
      */
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().requestLoader(callback, parameters);
              return;
            }
          }
      ...
      public static org.kde.necessitas.ministro.IMinistro sDefaultImpl;
    }
    static final int TRANSACTION_requestLoader = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(org.kde.necessitas.ministro.IMinistro impl) {
    ...
    public static org.kde.necessitas.ministro.IMinistro getDefaultImpl() {
